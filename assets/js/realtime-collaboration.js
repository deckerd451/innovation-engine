    ...
    if (!conversations || conversations.length === 0) {
      container.innerHTML = `
        <div style="text-align: center; padding: 2rem; color: rgba(255, 255, 255, 0.6);">
          ...
          <p style="font-size: 0.85rem;">Start a new conversation to get started</p>
        </div>
      `;
      return;
    }
          ...
          <div style="display: flex; align-items: center; gap: 1rem;">
            ...
            <div style="flex: 1; min-width: 0;">
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem;">
                <h4 style="color: white; margin: 0; font-size: 1rem; truncate;">${otherUser.name}</h4>
                ${unreadCount > 0 ? `<div class="unread-badge">${unreadCount}</div>` : ''}
              </div>
              <p style="color: rgba(255, 255, 255, 0.7); margin: 0; font-size: 0.85rem; truncate;">
