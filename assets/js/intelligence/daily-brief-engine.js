/**
 * ================================================================
 * DAILY INTELLIGENCE ENGINE  (assets/js/intelligence/daily-brief-engine.js)
 * ================================================================
 * Canonical location for the engine module used by start-daily-digest.js.
 * Imports explainability and journeyStore from same-directory shims which
 * in turn re-export from the root-level implementations.
 * ================================================================
 * ORIGINAL HEADER:
 * ================================================================
...
function _buildEventConnections({ eventInteractionEdges, community, userProfile, maxItems }) {
  ...
  // Deduplicate by other user — keep highest confidence edge
  ...
  for (const [otherId, edge] of bestByUser) {
    ...
    const why_key = registerWhy({
      ...
      signals: { overlap_seconds: edge.overlap_seconds, confidence: edge.confidence, beacon_id: edge.beacon_id },
