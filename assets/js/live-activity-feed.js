...
async function loadActivityFeed() {
  ...
  try {
    // Get recent activities (mock data for now, would come from activity_log table)
...
// Generate mock activities (replace with real data)
async function generateMockActivities() {
  const mockUsers = [
    { id: '1', name: 'Alex Chen', image_url: null },
    { id: '2', name: 'Sarah Johnson', image_url: null },
    { id: '3', name: 'Mike Rodriguez', image_url: null },
    { id: '4', name: 'Emily Davis', image_url: null },
    { id: '5', name: 'David Kim', image_url: null }
  ];
  ...
  const mockActivities = [
    ...
    },
    {
      ...
      metadata: { project_title: 'AI-Powered Health Tracker' }
    },
    {
      id: '3',
      type: ACTIVITY_TYPES.CONNECTION_MADE,
      user: mockUsers[2],
      target_user: mockUsers[3],
    ...
    },
    {
      ...
      metadata: { achievement: 'First Connection' }
    },
    {
      id: '5',
      type: ACTIVITY_TYPES.PROJECT_JOINED,
      ...
      metadata: { project_title: 'Sustainable Energy Dashboard' }
    }
  ];
